...
class AlertController extends Controller
{
    ...
    {
        return cache()->remember('AlertController@getWebStatus', now()->addMinutes(5), function() {
    ...
    {
        return cache()->remember('AlertController@getAlertStatus', now()->addMinutes(5), function() {
