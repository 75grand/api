...
class HoursController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        return cache()->remember('hours-calendar', now()->addHour(), function() {
            $calendar = (new ICal)->initUrl('https://calendar.google.com/calendar/ical/181235a736929aeeeff4459188a0ff4becaa3ca4bea67aeb82b1d2a15b179006%40group.calendar.google.com/public/basic.ics');
